...
function Header() {
  ...
  return (
    <nav class="absolute top-0 w-full bg-rich-black border-gray-200 px-2 sm:px-4 py-6">
      <div class="container flex flex-wrap justify-between items-center mx-auto">
        <a href="#" class="flex">
          <span class="self-center text-2xl font-black font-mont-serrat whitespace-nowrap text-white">
        ...
        <div class="hidden mobile-menu w-full md:block md:w-auto" id="mobile-menu">
          <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-extrabold font-mont-serrat">
            <li>
              <a
                href="#"
