      ...
      <div className='about-container md:flex md:justify-center md:w-11/11'>
        <div className='md:flex md:flex-col md:w-5/12 md:mr-40'>
          ...
          <div className='pt-10 text-sm text-justify md:text-base' id='about'>
            ...
            <p className='my-3'>
            Avançando para os dias atuais, tive o privilegio de começar a estudar na <b>trybe</b> e aprender de verdade como realmente funciona o desenvolvimento de uma pagina web, tanto como a parte <strong>front-end</strong>, <strong>back-end</strong> e também outros conceitos que engloba toda essa área fascinante.
            </p>
            <p className=''>
            Sou novo no mercado de tecnologia e busco sempre realizar bootcamps, cursos e implementar projetos sozinho, com tudo isso, acredito que estou preparado para dar meu primeiro passo na área.
            </p>
          </div>
          <div>
            <SkillsImage />
        ...
        <div className='flex justify-center flex-col'>
          <img className="pt-8 w-96 md:pt-0" src={ profileImg } alt="A selfie of myself" />
          <div className='pt-5 flex flex-col items-center md:hidden'>
